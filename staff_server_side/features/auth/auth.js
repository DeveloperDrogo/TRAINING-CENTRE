...
authRouter.post("/api/checkNumberIsExist", async (req, res) => {
  ...
  try {
    ...
    const getTrainingCenter = await trainingCenterModel.findById(checkNumberIsExist.training_center_id);
    ...
    if (getRole.role == "ADMIN") {
      ...
      if(getTrainingCenter.is_subscribed==1 && getTrainingCenter.is_deleted!=1){
